...
/** 管家上下文历史回放保留的最近对话回合数（普通会话为 10，管家更多，便于跨会话编排时保留更长上下文主线）
 * 【任务269】用户拍板 **10 轮**；【任务280】用户拍板调整为 **20 轮**；「1 轮」= 1 对完整回合（用户原始消息 + 该回合最终 assistant 正文），不含工具执行过程。 */
export const SUPERVISOR_MAX_HISTORY_TURNS = 20
